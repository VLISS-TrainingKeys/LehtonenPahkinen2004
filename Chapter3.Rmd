...
We calculate the parameter [DEFF](concepts/concepts.html) for [stratified](concepts/concepts.html) [simple random sampling](concepts/concepts.html) (STRSRS) with proportional allocation. Further instructions will be given once you start.
