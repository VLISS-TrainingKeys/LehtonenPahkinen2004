...
**Regression estimation of the total in the Province’91 population. The previously selected 
SRSWOR sample is used. There, the study variable UE91 is regressed with the auxiliary variable HOU85.
